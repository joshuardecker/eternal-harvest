...
var ui_manager_scene: PackedScene = preload("res://Managers/UI/ui.tscn")
var entity_manager_scene: PackedScene = preload("res://Managers/Entity/entity.tscn")
var settings_manager_scene: PackedScene = preload("res://Managers/Settings/settings.tscn")
var stats_manager_scene: PackedScene = preload("res://Managers/Stats/stats.tscn")
